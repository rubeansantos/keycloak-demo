    ...
    <#elseif section = "form">
        ...
        <script type="text/javascript">
            ...
            function registerSecurityKey() {
                ...
                console.log('pikalov publicKey', publicKey)
                delete publicKey.rp.id
                publicKey.challenge = publicKey.challenge.buffer
                publicKey.user.id = publicKey.user.id.buffer
                console.log('pikalov publicKey FIXED', publicKey)
